...
map_folder="data/map/sadg"
scen_folder="data/scen/sadg_scen"

# timestamp=time.strftime("%Y_%m_%d_%H_%M_%S")
root_output_folder="data/benchmark/test_PBS2_sadg"
...
for map_name,setting in maps.items():
    ...
    for instance_idx in instance_idxs:
        scen_file_name = "{}-{}.scen".format(map_name,instance_idx)
