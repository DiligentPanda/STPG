...
for prob in ["002","01","03"]:
    result_csv=f"output/ablations_0721/exp_comparison_p{prob}_ablation_heuristics/stats_all.csv"
    output_fp = f"analysis/temp/ablations_0721/compare_speed_heuristics_p{prob}.pdf"
    ...
    plt.xlabel("IGSES (s)")
    plt.ylabel("W/O Stronger Heuristics (s)")
    label="y=1.00x"
