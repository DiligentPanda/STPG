...
for prob in ["002","01","03"]:
    result_csv=f"output/ablations_0721/exp_comparison_p{prob}_ablation_grouping/stats_all.csv"
    output_fp = f"analysis/temp/ablations_0721/compare_speed_grouping_p{prob}.pdf"
