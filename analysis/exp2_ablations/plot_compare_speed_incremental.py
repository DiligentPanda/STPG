...
for prob in ["002","01","03"]:
    result_csv=f"output/ablations_0721/exp_comparison_p{prob}_ablation_incremental/stats_all.csv"
    output_fp = f"analysis/temp/ablations_0721/compare_speed_incremental_p{prob}.pdf"
    ...
    algorithms=[
        ("No Incremental Implementation", ["search", "largest_diff", "all", "wcg_greedy", False, 1.0]),
        ("Incremental Implementation", ["search", "largest_diff", "all", "wcg_greedy", True, 1.0])
    ]
