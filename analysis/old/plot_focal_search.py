...
output_fp="analysis/temp/16891_exps/focal_search_{}.pdf".format(map_labels[0])
...
merged["solution_cost_ratio"]=((merged["trunc_cost_focal"])/(merged["trunc_cost_astar"]))
...
plt.yscale("log")
plt.hlines(1,1.0,1.1,color='r',linestyles='dashed')
