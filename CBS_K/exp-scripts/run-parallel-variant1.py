...
maps = {
        ...
        # "den520d":[20,70,10,5],
        "random-32-32-10":[25,35,10,5],
       }

for mapname,setting in maps.items():
    exe = os.path.abspath("../build/CBS-K") #specify the compiled execuatable here.
    theMap = os.path.abspath('./map/{}'.format(mapname))
    scen = os.path.abspath('./agent/{}-even/'.format(mapname))
    outputFolder = os.path.abspath('./2023-may-variant1-m1/{}-even-90'.format(mapname))
